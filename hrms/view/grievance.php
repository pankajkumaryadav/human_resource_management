...
function resolved(){
                               ...
                               $.ajax({
					type: "POST",
					url: "<?php echo SITE_PATH?>index.php?controller=grievance&function=resolvedPage",
...
function unresolved(){
                               ...
                               $.ajax({
					type: "POST",
					url: "<?php echo SITE_PATH?>index.php?controller=grievance&function=unresolvedPage",
...
function launchGrievance(){
                               ...
                               $.ajax({
					type: "POST",
					url: "<?php echo SITE_PATH?>index.php?controller=grievance&function=launchGrievance",
...
function searchGrievance(){
                               ...
                               $.ajax({
					type: "POST",
					url: "<?php echo SITE_PATH?>index.php?controller=grievance&function=searchGrievance",
...
<div id="templatemo_wrapper">
	...
	<div id="tempaltemo_header">
    	...
    	<div id="header_content">
			...
			<a href="<?php echo SITE_PATH?>index.php?controller=grievance&function=grievancePage" class="detail float_l"><?php echo GRIEVANCES; ?></a>
			...
			<div id="templatemo_sidebar">
               	<div id="templatemo_menu">
					<ul>
						...
						<li><a href="#" target="_parent" onclick="launchGrievance()"><?php echo LAUNCH_GRIEVANCES ?></a></li>
