			...
			<div id="templatemo_content">
				<div style = " width:100%; height:200px; backgroundcolor:black; border:solid 1px;">
					...
					<div id="short_text" align="center">
					 <form name="search" action="<?php echo SITE_PATH?>index.php?controller=employee&function=findupdateEmployee" method="post"> 
                               
                                    
                      <br/><strong>Employee Id :</strong><input type="text" name="txtID" id="txtID" size="30" alt="Enter Employee Id" />
                                          
                      <br/> <input type="button" value="Search" name="search"  onclick="fncUpdateEmp()"/>
...
function fncUpdateEmp() {
	var strVal1 = $("#txtID").val();
if(strVal1=="") { return false;}

    $.ajax({ 
     type: "GET",
     url: "<?php echo SITE_PATH?>index.php?controller=employee&function=updateEmployeeaction&searchval1="+strVal1,                  
      data: "",
