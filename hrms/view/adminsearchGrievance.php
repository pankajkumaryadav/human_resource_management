...
function search_data(gnumber){
    ...
    $.ajax({ 
      type: "POST",
      url: "<?php echo SITE_PATH?>index.php?controller=admingrievance&function=adminfindGrievance",                  //the script to call to get data          
                            
     data: "gnumber="+gnumber,
       
        success: function(response){
          $('#search_text').html(response);
...
<body>
				...
				<div style = " width:100%; height:250px; backgroundcolor:black; border:solid 1px;">
					<!--
			...
			<div id="search_text" align="center"></div>
