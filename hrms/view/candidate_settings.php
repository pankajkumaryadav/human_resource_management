<?php
/**
* Filename : candidate_setting.php
* Authour : Pankaj Kumar Yadav
* Description : allow candidate to change his/her password.
...
<script>
	function changePassword()
    {
       //alert("rrr");
            $.ajax({
				type: "POST",
				url: "<?php echo SITE_PATH?>index.php?controller=candidate&function=changePassword",
