...
<script src="<?php echo SITE_PATH;?>js/jquery-1.9.1.js"></script>
<script>
function fncload() {
	$('#result').load('<?php echo SITE_PATH?>index.php?controller=employee&function=listing1', function() {

	});
}

</script>
<input type="button" name="btnClick" value="Load" onclick="fncload()">
<div id="result"></div>
 <div id="wrapper">
