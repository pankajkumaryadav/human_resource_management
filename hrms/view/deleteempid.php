...
<li><a href="<?php echo SITE_PATH?>index.php?controller=employee&function=addEmployee">
<?php echo "Add Employee" ?></a></li></a></li> 
...
if(strVal1=="") { return false;}
    ...
    $.ajax({ 
     type: "GET",
     url: "<?php echo SITE_PATH?>index.php?controller=employee&function=deleteEmployeeaction&searchval1="+strVal1,                  
      data: "",
